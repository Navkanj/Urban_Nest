            ...
            <header className="header">
                ...
                <nav className="navbar nav-1">
                    <section className="flex">
                            <ul>
                                <li>
                            <Link to="/home" className="logo"><i className="fas fa-house"></i>UrbanNest</Link>
                                </li>
                                <li className='hover:text-zinc-700 py-2'><Link to="#">buy<i className="fas fa-angle-down"></i></Link>
                                ...
                                <li className='py-2'><Link to="#">sell<i className="fas fa-angle-down"></i></Link>
                                    <ul className='Dropdown'  style={{boxShadow:"0px 0px 7px 0px rgba(0,0,0,0.1)"}}>
                                        <li><Link to="#">post property</Link></li>
                                        <li><Link to="#">dashboard</Link></li>
                                    </ul>
                                </li>
                                <li className='py-2'><Link to="#">rent<i className="fas fa-angle-down"></i></Link>
                                    <ul className='Dropdown'  style={{boxShadow:"0px 0px 7px 0px rgba(0,0,0,0.1)"}}>
                                        <li><Link to="#">house</Link></li>
                                        <li><Link to="#">flat</Link></li>
                                        <li><Link to="#">shop</Link></li>
                                ...
                                <li className='py-2'><Link to="#">help<i className="fas fa-angle-down"></i></Link>
                                    <ul className='Dropdown'  style={{boxShadow:"0px 0px 7px 0px rgba(0,0,0,0.1)"}}>
