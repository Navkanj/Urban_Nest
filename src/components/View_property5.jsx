        ...
        <>
            ...
            <section className="view-property">
                <div className="details">
                    ...
                    <p className="location"><i className="fas fa-map-marker-alt"></i><span>Chennai, India</span></p>
                    <div className="info">
                        <p><i className="fas fa-tag"></i><span>26 lac</span></p>
                        <p><i className="fas fa-user"></i><span>Naman (owner)</span></p>
                        ...
                        <p><i className="fas fa-calendar"></i><span>10-06-2023</span></p>
                    </div>
