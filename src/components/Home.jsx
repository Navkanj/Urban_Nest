                ...
                <section className="center mb-5">
                    <div className="slideshow-container">
                        {slides.map((slide, index) => (
                            ...
                            >
                                <img src={slide} className="d-block w-100 imageSlide" alt={`Slide ${index + 1}`} />
                            </div>
                        ))}
                    </div>
                    <form className="rounded-md">
                        ...
                        <Link to="/search" ><input type="submit" value="search property" name="search" class="btn" /></Link>
                    </form>
            ...
            <section class="listings mt-5 mb-5">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        ...
                        <h3 class="name">Flats and Apartments</h3>
                    ...
                    <div class="box">
                        ...
                        <h3 class="name">Flats and Appartments</h3>
