        ...
        <>
            ...
            <section className="view-property">
                <div className="details">
                    ...
                    <p className="location"><i className="fas fa-map-marker-alt"></i><span>Mumbai, India</span></p>
                    <div className="info">
                        <p><i className="fas fa-tag"></i><span>25 lac</span></p>
                        <p><i className="fas fa-user"></i><span>Pankaj (owner)</span></p>
                        ...
                        <p><i className="fas fa-calendar"></i><span>10-05-2023</span></p>
                    </div>
                    ...
                    <div className="flex">
                        ...
                        <div className="box">
                            <p><i>Carpet area :</i><span>790 sqft</span></p>
